...
The goal of makemyownpackageregexcite is to make splitting one string easier. 

## Installation

You can install the development version of makemyownpackageregexcite from [GitHub](https://github.com/) with:
